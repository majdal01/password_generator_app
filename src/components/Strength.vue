...
<template>
    ...
    <button type="button" @click="emit('generate')" id="generate-button">Generate <span><img class="arrow" src="/assets/images/icon-arrow-right.svg" alt="" aria-hidden="true"></span></button>
</template>
